...
- 正在摸索系统级编程语言。主修Rust中 ~~（呵呵，在C++之前学Rust的这辈子真有了）~~
...
- 喜欢弹钢琴，喜欢玩一些动作类的单机游戏（Yes，已经掉进了ZZZ的坑里了）
...
I'm an UGRD student at Sun Yat-sen university (China Mainland), currently on the journey of leveling up!

**🌱I'm currently:**

- Exploring system-level programming languages. Majoring in Rust ~~(joking that never thought I'd learn Rust before C++)~~
...
- Playing the piano and diving into action single-player games (Yes, I've already fallen into Zenless Zone Zero)
